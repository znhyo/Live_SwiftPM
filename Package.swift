...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "38e4334e37f5148e5b9c0680b63699b3d087a8bab7fd76209e87c4291d1cf3a2"
        ),
        .binaryTarget(
            name: "TXFFmpeg",
        ...
        .binaryTarget(
            ...
            checksum: "5c860a3103f4416aa15d2f57d7613e24a5aa1b7256cafec7304df6cec008fc3b"
        ),
        .binaryTarget(
            name: "TXSoundTouch",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.2/live/TXSoundTouch.xcframework.zip",
            checksum: "d97a3edb3966ee3b1e3061bc67b0ba24df2fca2ced1793e88e712733e8b63fd1"
        ),.target(
            name: "Live_SwiftPM",
            dependencies: [
